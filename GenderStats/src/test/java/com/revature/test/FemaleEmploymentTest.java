...
import com.revature.reduce.FemaleEmploymentDiffReducer;

public class FemaleEmploymentTest {
	String testInput = "\"United States\",\"USA\",\"Employment to population ratio, 15+, female"
	...
	public void setup() {
		...
		FemaleEmploymentDiffReducer reducer = new FemaleEmploymentDiffReducer();
